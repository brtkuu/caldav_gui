<template>
  <div class="container">
    <form action>
      ...
      <input type="number" for="every" id="every" disabled />
      <br />
...
export default {
  ...
  methods: {
    addEvent() {
      ...
      const selectCollection = document.getElementById("collection").value;
    ...
    allDayEvent() {
      ...
      document.querySelector("#end").disabled = !document.querySelector("#end")
        .disabled;
    }
  },
  mounted() {
